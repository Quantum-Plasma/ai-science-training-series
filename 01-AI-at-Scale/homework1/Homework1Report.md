...
Under large dimension, the random generated data and the hdf5 data loading process are compared. Both cases are run under large data set where src=torch.rand((2048,20,512), and tgt=torch.rand((2048,100,512). Comparing Figure 7 and Figure 3, the loading time of hdf5 file is 386ms and the loading time of code generated data is 273ms for a single rank process. The data loading time readin hdf5 is longer than the preloaded data set.

<figure>
  <img src="./Assets/LargeHdf5.jpg" />
  <p align="center"><em>Figure 7:Data Read from hdf5</em></p>
</figure>
