...
from QuanGan_tools import calc_CCRF_amplifier_wavenumber
...
tools = [calc_CCRF_amplifier_wavenumber]
...
graph_builder.add_node(
    "tool_agent",
    lambda state: tool_agent(state, llm=llm, tools=tools),
)
graph_builder.add_node(
...
# Graph logic
# START -> tool_agent
graph_builder.add_edge(START, "tool_agent")

# After chem_agent runs, check if we need to run tools
graph_builder.add_conditional_edges(
    "tool_agent", route_tools, {"tools": "tools", "done": "structured_output_agent"}
)
...
# ============================================================
prompt = "Calculate the wavenumber of the CCRF_Amplifier at 1.5 GHz."
